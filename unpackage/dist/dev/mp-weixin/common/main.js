...
/***/ 0:
/*!*********************************************!*\
  !*** /Users/damowang/Downloads/App/main.js ***!
  \*********************************************/
...
// +---------------------------------------------------------------------
var skeleton = function skeleton() {__webpack_require__.e(/*! require.ensure | components/skeleton/index */ "components/skeleton/index").then((function () {return resolve(__webpack_require__(/*! ./components/skeleton/index.vue */ 615));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('skeleton', skeleton);_vue.default.prototype.$util = _util.default;_vue.default.prototype.$config = _app.default;_vue.default.prototype.$Cache = _cache.default;_vue.default.prototype.$eventHub = new _vue.default();_vue.default.config.productionTip = false;
_vue.default.prototype.$Order = Order;
...
/***/ 29:
/*!*******************************************************************************!*\
  !*** /Users/damowang/Downloads/App/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ 6:
/*!*********************************************!*\
  !*** /Users/damowang/Downloads/App/App.vue ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 7:
/*!**********************************************************************!*\
  !*** /Users/damowang/Downloads/App/App.vue?vue&type=script&lang=js& ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _routine = _interopRequireDefault(__webpack_require__(/*! ./libs/routine.js */ 25));
var _apps = _interopRequireDefault(__webpack_require__(/*! ./libs/apps.js */ 27));
...
var app = getApp();var _default =
{
  ...
  onLaunch: function onLaunch(option) {
    ...
    if (option.query.hasOwnProperty('scene')) {
      switch (option.scene) {
        ...
        case 1001: //直接进入小程序
          var value = this.$util.getUrlParams(decodeURIComponent(option.query.scene));
    ...
    if (!this.$store.getters.isLogin) {
      _routine.default.getCode().then(function (code) {
        _routine.default.authUserInfo(code);
      }).
      catch(function (res) {
        uni.hideLoading();
      });
    ...
    // 主题变色
    (0, _api.getTheme)().then(function (resP) {
      that.globalData.theme = "theme".concat(Number(resP.data.value));
  ...
  mounted: function mounted() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
              _this.$store.getters.isLogin && !_this.$Cache.get('USER_INFO'))) {_context.next = 3;break;}_context.next = 3;return _this.$store.dispatch('USERINFO');case 3:case "end":return _context.stop();}}}, _callee);}))();
  },
  methods: {},
